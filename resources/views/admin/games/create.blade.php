...
<div class="container">
    ...
    <form action="{{ route('admin.games.store') }}" method="POST" style="max-width: 800px;">
        @csrf
        ...
        <div class="form-group">
            <label style="display: flex; align-items: center; gap: 0.5rem;">
                <input type="checkbox" name="is_on_sale" value="1" {{ old('is_on_sale') ? 'checked' : '' }} style="width: auto;">
        ...
        <div class="form-group">
            ...
            <input type="number" name="sale_percentage" step="0.01" min="0" max="100" value="{{ old('sale_percentage') }}" placeholder="e.g., 25 for 25% off">
